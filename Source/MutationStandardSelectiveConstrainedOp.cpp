...
/*!
 *  \file   beagle/GP/src/MutationStandardSelectiveConstrainedOp.cpp
 *  \brief  Source code of class GP::MutationStandardSelectiveConstrainedOp.
 ...
 */
GP::MutationStandardSelectiveConstrainedOp::MutationStandardSelectiveConstrainedOp(GP::InitializationOp::Handle inInitOp,
 ...
 */
void GP::MutationStandardSelectiveConstrainedOp::initialize(Beagle::System& ioSystem)
{
	Beagle_StackTraceBeginM();
	MutationStandardConstrainedOp::initialize(ioSystem);
	SelectiveConstrainedSelectionOp::initialize(ioSystem);
	
	Beagle_StackTraceEndM("void GP::MutationStandardSelectiveConstrainedOp::registerParams(Beagle::System&)");
}
