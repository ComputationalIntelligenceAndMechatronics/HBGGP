...
/*!
 *  \file   beagle/GP/src/MutationSwapDepthSelectiveConstrainedOp.cpp
 *  \brief  Source code of class GP::MutationSwapDepthSelectiveConstrainedOp.
 ...
 */
GP::MutationSwapDepthSelectiveConstrainedOp::MutationSwapDepthSelectiveConstrainedOp(std::string inMutationPbName,
 ...
 */
void GP::MutationSwapDepthSelectiveConstrainedOp::initialize(Beagle::System& ioSystem)
{
	Beagle_StackTraceBeginM();
	MutationSwapConstrainedOp::initialize(ioSystem);
	DepthDependentSelectionOp::initialize(ioSystem);
	Beagle_StackTraceEndM("void GP::MutationSwapDepthSelectiveConstrainedOp::registerParams(Beagle::System&)");
}
