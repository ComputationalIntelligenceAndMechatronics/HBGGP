...
/*!
 *  \file   beagle/GP/MutationSwapSubtreeDepthSelectiveConstrainedOp.hpp
 *  \brief  Definition of the class GP::MutationSwapSubtreeDepthSelectiveConstrainedOp.
...
#ifndef Beagle_GP_MutationSwapSubtreeDepthSelectiveConstrainedOp_hpp
#define Beagle_GP_MutationSwapSubtreeDepthSelectiveConstrainedOp_hpp
 ...
 *  the other subtree.
 */
class MutationSwapSubtreeDepthSelectiveConstrainedOp : public MutationSwapSubtreeConstrainedOp, public DepthDependentSelectionOp {

public:

  //! GP::MutationSwapSubtreeDepthSelectiveConstrainedOp allocator type.
  typedef AllocatorT<MutationSwapSubtreeDepthSelectiveConstrainedOp,MutationSwapSubtreeConstrainedOp::Alloc>
          Alloc;
  //! GP::MutationSwapSubtreeDepthSelectiveConstrainedOp handle type.
  typedef PointerT<MutationSwapSubtreeDepthSelectiveConstrainedOp,MutationSwapSubtreeConstrainedOp::Handle>
          Handle;
  //! GP::MutationSwapSubtreeDepthSelectiveConstrainedOp bag type.
  typedef ContainerT<MutationSwapSubtreeDepthSelectiveConstrainedOp,MutationSwapSubtreeConstrainedOp::Bag>
          Bag;

  explicit MutationSwapSubtreeDepthSelectiveConstrainedOp(std::string inMutationPbName="gp.mutsst.indpb",
                                            std::string inDistribPbName="gp.mutsst.distrpb",
                                            std::string inName="GP-MutationSwapSubtreeDepthSelectiveConstrainedOp");
  virtual ~MutationSwapSubtreeDepthSelectiveConstrainedOp() { }
