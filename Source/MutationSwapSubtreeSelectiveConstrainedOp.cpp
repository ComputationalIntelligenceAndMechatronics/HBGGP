...
/*!
 *  \file   beagle/GP/src/MutationSwapSubtreeSelectiveConstrainedOp.cpp
 *  \brief  Source code of class GP::MutationSwapSubtreeSelectiveConstrainedOp.
...
#include "MutationSwapSubtreeSelectiveConstrainedOp.hpp"
#include <algorithm>
#include <string>
 ...
 */
GP::MutationSwapSubtreeSelectiveConstrainedOp::MutationSwapSubtreeSelectiveConstrainedOp(
 ...
 */
bool GP::MutationSwapSubtreeSelectiveConstrainedOp::mutate(Beagle::Individual& ioIndividual, Beagle::Context& ioContext)
{
  ...
  Beagle_LogDebugM(
    ...
    "mutation", "Beagle::GP::MutationSwapSubtreeSelectiveConstrainedOp",
...
//	  }
  ...
  return lMatingDone;
  Beagle_StackTraceEndM("bool GP::MutationSwapSubtreeSelectiveConstrainedOp::mutate(Beagle::Individual& ioIndividual, Beagle::Context& ioContext)");
}
