 ...
 */
GP::CrossoverSelectiveConstrainedOp::CrossoverSelectiveConstrainedOp(Beagle::string inMatingPbName,
 ...
 */
void GP::CrossoverSelectiveConstrainedOp::initialize(Beagle::System& ioSystem)
{
	...
	Beagle_StackTraceEndM("void GP::CrossoverSelectiveConstrainedOp::initialize(Beagle::System& ioSystem)");
}
 ...
 */
bool GP::CrossoverSelectiveConstrainedOp::mate(Beagle::Individual& ioIndiv1, Beagle::Context& ioContext1,
											   Beagle::Individual& ioIndiv2, Beagle::Context& ioContext2)
{
	...
	Beagle_LogDebugM(  
					 ...
					 "crossover", "Beagle::GP::CrossoverSelectiveConstrainedOp",
	...
	for(unsigned int lAttempt=0; lAttempt < mNumberAttempts->getWrappedValue(); ++lAttempt) {
		...
		for(unsigned int lTry = 0; lTry < 2; ++lTry) { //Do only twice
			...
			SelectiveConstrainedSelectionOp::buildRoulette(lRoulette1, lTypeNode1, lDesiredTypes, lIndiv1, lContext1,!lDoParameterSearch,lDoParameterSearch);
			...
			if(lRoulette1.size() != 0)
				lIndiv2HasTyping = SelectiveConstrainedSelectionOp::hasOutputTypes(lDesiredTypes, lIndiv2, lContext2,!lDoParameterSearch);
		...
		bool lGoodSelect = SelectiveConstrainedSelectionOp::selectNodeToMateWithTypes(lChoosenTree2,
													 lChoosenNode2,
													 lTypeNode2,
													 lDesiredType,
													 lPrimitiveSetIndex1,
		...
		if(lGoodSelect==false) {
			...
			//Try again by changing the leaf/branche requirement
			lGoodSelect = SelectiveConstrainedSelectionOp::selectNodeToMateWithTypes(lChoosenTree2,
													lChoosenNode2,
													!lTypeNode2,
													lDesiredType,
													lPrimitiveSetIndex1,
	...
	if(lMatingDone) {
		...
		if( !lDoParameterSearch ) {
			...
			Beagle_LogVerboseM(
							   ioContext1.getSystem().getLogger(),
							   "mutation", "Beagle::GP::CrossoverSelectiveConstrainedOp",
	...
	return lMatingDone;
	Beagle_StackTraceEndM("bool GP::CrossoverSelectiveConstrainedOp::mate(Individual& ioIndiv1, Context& ioContext1, Individual& ioIndiv2, Context& ioContext2)");
}
