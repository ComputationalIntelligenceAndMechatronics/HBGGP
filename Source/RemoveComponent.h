...
class RemoveComponent : public BGPrimitive {
public:
	typedef AllocatorT<RemoveComponent,BGPrimitive::Alloc> Alloc;
	typedef PointerT<RemoveComponent,BGPrimitive::Handle> Handle;
	typedef ContainerT<RemoveComponent,BGPrimitive::Bag>	Bag;
	
	RemoveComponent(std::string inName="RemoveComponent") : BGPrimitive(0, inName) {}
	~RemoveComponent() {}
