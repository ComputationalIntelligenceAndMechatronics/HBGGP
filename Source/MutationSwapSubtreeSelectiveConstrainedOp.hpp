...
/*!
 *  \file   beagle/GP/MutationSwapSubtreeSelectiveConstrainedOp.hpp
 *  \brief  Definition of the class GP::MutationSwapSubtreeSelectiveConstrainedOp.
...
#ifndef Beagle_GP_MutationSwapSubtreeSelectiveConstrainedOp_hpp
#define Beagle_GP_MutationSwapSubtreeSelectiveConstrainedOp_hpp
 ...
 *  the other subtree.
 */
class MutationSwapSubtreeSelectiveConstrainedOp : public MutationSwapSubtreeConstrainedOp, public SelectiveConstrainedSelectionOp {

public:

  //! GP::MutationSwapSubtreeSelectiveConstrainedOp allocator type.
  typedef AllocatorT<MutationSwapSubtreeSelectiveConstrainedOp,MutationSwapSubtreeConstrainedOp::Alloc>
          Alloc;
  //! GP::MutationSwapSubtreeSelectiveConstrainedOp handle type.
  typedef PointerT<MutationSwapSubtreeSelectiveConstrainedOp,MutationSwapSubtreeConstrainedOp::Handle>
          Handle;
  //! GP::MutationSwapSubtreeSelectiveConstrainedOp bag type.
  typedef ContainerT<MutationSwapSubtreeSelectiveConstrainedOp,MutationSwapSubtreeConstrainedOp::Bag>
          Bag;

  explicit MutationSwapSubtreeSelectiveConstrainedOp(std::string inMutationPbName="gp.mutsst.indpb",
                                            std::string inDistribPbName="gp.mutsst.distrpb",
                                            std::string inName="GP-MutationSwapSubtreeSelectiveConstrainedOp");
  virtual ~MutationSwapSubtreeSelectiveConstrainedOp() { }
