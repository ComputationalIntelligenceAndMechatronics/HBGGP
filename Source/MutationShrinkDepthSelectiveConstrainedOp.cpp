...
/*!
 *  \file   beagle/GP/src/MutationShrinkDepthSelectiveConstrainedOp.cpp
 *  \brief  Source code of class GP::MutationShrinkDepthSelectiveConstrainedOp.
 ...
 */
GP::MutationShrinkDepthSelectiveConstrainedOp::MutationShrinkDepthSelectiveConstrainedOp(std::string inMutationPbName,
																			   std::string inName) :
 ...
 */
void GP::MutationShrinkDepthSelectiveConstrainedOp::initialize(Beagle::System& ioSystem)
{
	Beagle_StackTraceBeginM();
	MutationShrinkConstrainedOp::initialize(ioSystem);
	DepthDependentSelectionOp::initialize(ioSystem);
	Beagle_StackTraceEndM("void GP::MutationShrinkDepthSelectiveConstrainedOp::registerParams(Beagle::System&)");
}
 ...
 */
bool GP::MutationShrinkDepthSelectiveConstrainedOp::mutate(Beagle::Individual& ioIndividual, Beagle::Context& ioContext)
{
	Beagle_StackTraceBeginM();
		...
		if(lRoulette.size() == 0) {
			if(lDoParameterSearch) {
				Beagle_LogVerboseM(
								   ...
								   "mutation", "Beagle::GP::MutationShrinkDepthSelectiveConstrainedOp",
	...
	Beagle_StackTraceEndM("bool GP::MutationShrinkDepthSelectiveConstrainedOp::mutate(Beagle::Individual& ioIndividual, Beagle::Context& ioContext)");
}
